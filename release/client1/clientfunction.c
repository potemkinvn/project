...
int sendInvitation()
{
    ...
    printf("Waiting response from player '%s' ...\n", name);
    bytes_received = recv(client_sock,buff,1024,0);
    if(bytes_received <= 0) {
        ...
        case 0:
            ...
            if(turn!=side) {
                ...
                if(ms.command == 303) {
                    ...
                    gameresult = 5;
                    break;
                } else if(strcmp(ms.message, "quit")==0) {
                    /// my opp has surrender
                    /// black won - white quit
                    gameresult = 7;
                    break;
                }
...
int ReceiveLog()
{
    ...
    printf("\nReceived log file %s.", logFileName);
...
void ParseGameResult(int resultCode, char resultText[])
{
    ...
    case 6:
        ...
        break;
    case 7:
        strcpy(resultText, "\nBlack won - White has surrendered!!\n");
        break;
    case 8:
        strcpy(resultText, "\nWhite won - Black has surrendered!!\n");
        break;
    }
}
